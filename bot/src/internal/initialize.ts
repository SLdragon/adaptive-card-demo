...
import { GetPetCommandHandler } from "../getPetCommandHandler";
import { ListPetsCommandHandler } from "../listPetsCommandHandler";
...
export const commandBot = new ConversationBot({
  ...
  command: {
    enabled: true,
    commands: [new GetPetCommandHandler(), new ListPetsCommandHandler()],
  },
});
